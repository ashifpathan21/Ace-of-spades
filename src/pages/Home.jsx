...
const Home = () => {
  const review = [
    {
      ...
      rating: 4.5,
      review:
        "Amazing experience! The content was well-structured and easy to follow.",
      date: "April 20, 2025",
    },
    {
      user: {
      ...
      rating: 5,
      review:
        "Perfect course! Loved every bit of it. The examples were super clear.",
      date: "April 18, 2025",
    },
    {
      user: {
      ...
      rating: 3.5,
      review:
        "Good course for beginners. Some advanced topics were missing though.",
      date: "April 15, 2025",
    },
    {
      user: {
      ...
      rating: 4,
      review:
        "Really helpful and well-paced. I would recommend it to my juniors.",
      date: "April 12, 2025",
    },
    {
      user: {
  ...
  useEffect(() => {
    ...
    if (!sessionStorage.getItem("categories")) getCategory();
  }, []);
  ...
  return (
    <div className="w-screen relative transition-all duration-700 scroll-smooth overflow-x-hidden">
      ...
      {help ? ( //ai chat
        <div className="fixed text-black z-10 backdrop-blur-3xl   h-[80%] w-70 border transition-all  duration-500 shadow-md   bottom-0 mb-3  right-5 flex gap-3 flex-col p-2  justify-start  items-center   rounded-lg ">
          <div className="bg-white w-full flex ">
            ...
            <h1 className="text-2xl bg-white  w-full text-center p-2  font-bold ">
              Chat Support
            </h1>
          </div>
          ...
          <div
            ref={messageBoxRef}
            className="border px-4 py-2 message-box rounded h-full mb-22 overflow-y-auto w-full  "
          >
            {loading ? (
      ...
      <div className="my-5 p-3 ">
        <h1 className="text-2xl mb-5 font-bold flex justify-center uppercase">
          OUR REVIEWS
        </h1>
