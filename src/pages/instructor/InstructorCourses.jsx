...
const InstructorCourses = () => {
  ...
  return (
    ...
    { loading ? <div className='min-h-screen w-full flex justify-center items-center '><span className='loader'></span></div> : 
      <div className="max-w-[500px] md:max-w-[750px] lg:max-w-[1000px]  mx-auto p-4">
        <div className=" flex items-center justify-between mb-4">
         ...
         <button
          ...
          className=" hover:bg-cyan-200 shadow-cyan-300 shadow font-bold py-2 px-4 rounded">Dashboard</button>
