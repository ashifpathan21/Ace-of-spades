...
import {
  fetchAverageRating,
  sendFeedBack,
} from "./../services/operations/ratingAndReview.js";
...
const Enroll = () => {
    ...
    async function getAverage() {
      ...
      try {
        const responce = await dispatch(
          fetchAverageRating({ courseId: course._id })
        );
  ...
  const addFeedback = async (e) => {
    ...
    try {
      setLoading(true);
      const responce = await dispatch(
        sendFeedBack({ rating, review: feedback, courseId: course._id }, token)
      );
    } catch (error) {
      toast.error("Something Went Wrong");
    }
      ...
      {loading ? (
        ...
        <div className="gap-10 flex-col backdrop-blur-2xl h-full min-h-screen relative w-screen flex justify-center items-center">
          ...
          <form
            ...
            className="max-w-[500px] w-full md:max-w-[650px] flex flex-col gap-3 lg:max-w-[800px] mx-auto backdrop-blur-3xl rounded-lg shadow shadow-cyan-300 p-4"
          >
            <p>Review</p>
            <textarea
              required
              ...
              rows="3"
              className="bg-white p-2 rounded-lg text-black resize-none border"
                ...
                return (
                  ...
                  >
                    <FaStar
                      size={28}
                      className={
                        current <= rating ? "text-yellow-400" : "text-gray-300"
                      }
                    />
                  </button>
                );
            ...
            <button
              className="p-2 text-xl capitalize bg-green-400 rounded-lg mt-10 text-slate-200 font-semibold"
              type="submit"
            >
              Submit
            </button>
        ...
        <div className="w-full pt-20 relative">
          <h2 className="w-full capitalize text-center p-2 text-xl md:text-2xl lg:text-3xl font-semibold">
            {course?.courseName}
          </h2>
          <div className="max-w-[1000px] mt-5 mx-auto  flex flex-col  p-3">
            <div className="flex flex-col gap-3 justify-center mx-auto">
              <img
                ...
                className="object-cover h-60 rounded-lg border-2 border-gray-800"
              />
            ...
            <div className="px-2 mt-5 flex flex-col gap-2 w-full ">
              <h2 className="text-xl p-2 mt-3  list-disc font-semibold capitalize">
                Course Description
              </h2>
              <div
              ...
              />
              <h2 className="text-xl p-2  list-disc  mt-3 font-semibold capitalize">
                What you will learn?
              </h2>
              <div
                className="prose dark:prose-invert"
              ...
              />
              <h2 className="text-xl capitalize p-2 mt-3 font-semibold">
                Instructions
              </h2>
              <div
        ...
        <div className="w-full h-full p-4 gap-4 mb-20 flex flex-col">
          ...
          {!reviewed && (
            <button
              ...
              className="p-3 font-bold mt-10 text-lg bg-green-400 rounded-2xl text-white"
            >
              Add Review
            </button>
          )}
