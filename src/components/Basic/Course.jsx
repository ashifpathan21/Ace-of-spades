...
const Course = (props) => {
  ...
  return (
    ...
    <img src={props.course?.thumbnail} className='object-cover h-60 w-full aspect-video drop-shadow-2xl rounded-lg ' />
     <div>
         <h2 className='font-semibold text-lg p-2'>{props.course?.courseName}</h2>
      </div>
     <button
     onClick={() => {
