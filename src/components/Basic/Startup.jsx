...
const Startup = (props) => {
  return (
    <div className="mb-25 w-full  h-80 p-3 relative ">
      <h1 className="w-full  text-center py-2 text-2xl  font-bold transition-all  duration-500">
        Have Some Idea ?
      </h1>
      ...
      <Tilt
        ...
        className=" w-full lg:max-w-[1000px] md:max-w-[800px] max-w-[500px] mx-auto h-80 p-3 "
      >
        <div className="h-[95%] max-w-[1000px] p-2 mx-auto w-full flex  justify-between">
          ...
          <div className="flex gap-3 flex-col p-2 justify-center items-center h-[80%] w-[48%] mt-4 ">
            <img
              src={startup}
              className="rounded-lg h-40 object-cover drop-shadow-2xl"
            />

            <button
              className={
                props.isDarkMode
                  ? "bg-white transition-all w-40  hover:bg-amber-100 duration-1000  text-black p-2 font-semibold  rounded-lg "
                  : "bg-black transition-all hover:bg-gray-800 duration-1000  text-white p-2 font-semibold w-40 rounded-lg"
              }
            >
              Share Your Idea
            </button>
