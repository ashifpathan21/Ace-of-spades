...
const Dashboard = () => {
  ...
  const {courses} = useSelector((state)=> state.instructorCourses)
        ...
        return (
            <div className='pt-20 '>
                <h2 className='w-full text-xl md:text-2xl lg:text-2xl font-semibold text-center p-2 '>Dashboard</h2>
              ...
              <div>
                <InstructorsCourses setCourseId={setCourseId} showThisCourseDetails={showThisCourseDetails}  setShowThisCourseDetails={setShowThisCourseDetails} / >
              </div>
