...
import { fetchColleges } from "../../services/operations/detailsApi.js";
...
const Details = (props) => {
  ...
  const checkUserNameAvailability = async (userName) => {
    ...
    try {
      const response = await axios.post(
        `${import.meta.env.VITE_BASE_URL}/auth/username`,
        { userName: userName }
      );
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      dispatch(fetchColleges(collegeName));
    }, 300);
          ...
          <div className="h-screen w-full relative flex flex-col gap-20 justify-center items-center p-2 md:p-4 lg:p-8">
            ...
            <div className="max-w-[500px] md:max-w-[700px] lg:max-w-[900px] mx-auto">
              <form
                ...
                className="gap-30 flex justify-center flex-col "
              >
                ...
                <button className="  bg-green-600 rounded-lg px-6  p-2">
                  {" "}
                  Submit
                </button>
              </form>
        ...
        <div className="min-h-screen w-full flex relative flex-col items-center p-4 text-white">
          <div className="p-4">
            <div
              ...
              className="absolute text-black bg-white rounded-lg  left-4 px-2 -mt-3 text-3xl"
            >
              {" "}
          ...
          <div className="grid grid-cols-2 px-3 py-2 w-full max-w-[500px] mb-5 mt-3 bg-white text-black rounded-lg items-center">
            <button
              ...
              className={`font-bold rounded-md transition-all duration-1000 p-2 ${
                mode === "login" ? "bg-slate-400" : "bg-white"
              }`}
            >
              LogIn
            </button>
            <button
              ...
              className={`font-bold rounded-md transition-all duration-1000 p-2 ${
                mode === "login" ? "bg-white" : "bg-slate-400"
              }`}
            >
              SignUp
            </button>
          ...
          {loading ? (
            ...
            <div className="flex justify-center items-center">
              <form
                ...
                className="w-full max-w-[650px] gap-3 flex flex-col p-5"
              >
                ...
                <div className="w-full mt-6 text-center">
                  <button
                    className={`transition-all duration-1000 p-2 font-semibold rounded-lg w-50 ${
                      mode
              ...
              >
                ...
                <div className="relative gap-2 flex flex-col">
                  ...
                  {suggestions.length > 0 && (
                    <ul className="absolute z-10 bg-white text-black border border-cyan-400  top-18 rounded-md shadow-md max-h-48 overflow-y-auto w-full">
                ...
                {userNameStatus === "checking" && (
                  <p className="text-sm">Checking username availability...</p>
                )}
